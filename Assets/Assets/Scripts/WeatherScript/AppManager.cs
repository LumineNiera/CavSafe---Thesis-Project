...
public class AppManager : MonoBehaviour
{
   ...
   // public WeatherStates weatherController;
    ...
    {
        var weatherAPI = new UnityWebRequest("https://api.openweathermap.org/data/2.5/weather?q="+ip.ipCity+","+ip.ipCountry+"&units=metric&APPID=c81935ebad36fb8845e64ae63f4a4dbd")
